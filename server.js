...
function getPrecachedQuickQuestionAnswer(cleanQ, lang) {
    ...
    if (q.includes('how does') || q.includes('how test') || (q.includes('work') && q.includes('test')) || q.includes('काम करता') || q.includes('कैसे काम') || q.includes('funciona la prueba') || q.includes('fonctionne le test') || q.includes('funktioniert der test') || q.includes('どのように') || q.includes('如何进行')) {
